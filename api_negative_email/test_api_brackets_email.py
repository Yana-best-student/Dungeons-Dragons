...
@allure.title("Регистрация  email c несбалансированными скобками")
@allure.description("""
Тест проверяет реакцию системы на попытку регистрации  email c несбалансированными скобками.
...
def test_invalid_local_email():
    """
    Негативный тест регистрации с недопустимым email (c несбалансированными скобками).
