...
@allure.title("Регистрация с email без домена")
@allure.description("""
Тест проверяет реакцию системы на попытку регистрации с email без домена.
