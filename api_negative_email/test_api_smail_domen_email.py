...
@allure.title("Регистрация email с эмодзи в доменной части")
@allure.description("""
Тест проверяет реакцию системы на попытку регистрации с email, содержащим эмодзи в доменной части.
Ожидается отказ регистрации с соответствующим сообщением об ошибке.
""")
@allure.tag("Negative", "EmailValidation", "Registration")
def test_invalid_domain_email_with_emoji():
    """
    Негативный тест регистрации с email, содержащим эмодзи в доменной части.
    Ожидается отказ регистрации с сообщением об ошибке.
    """

    # Недопустимый email (эмодзи в доменной части)
    invalid_email = "bilkina@staff😚org.ru"
