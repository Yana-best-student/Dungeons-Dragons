...
@allure.title("Регистрация  email c пробелами в локальной части")
@allure.description("""
Тест проверяет реакцию системы на попытку регистрации  email c пробелами в локальной части.
...
def test_invalid_local_email():
    """
    Негативный тест регистрации с недопустимым email (c пробелами в локальной части).
