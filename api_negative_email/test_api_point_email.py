...
@allure.title("Регистрация email с точкой в начале")
@allure.description("""
Тест проверяет реакцию системы на попытку регистрации  email c точкой в начале.
...
def test_invalid_local_email():
    """
    Негативный тест регистрации с недопустимым email (c точкой в начале).
