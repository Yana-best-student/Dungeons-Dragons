...
@allure.title("Регистрация email с двумя точками подряд")
@allure.description("""
Тест проверяет реакцию системы на попытку регистрации  email c двумя точками подряд.
...
def test_invalid_local_email():
    """
    Негативный тест регистрации с недопустимым email (c двумя точками подряд).
    Ожидается отказ регистрации с сообщением об ошибке.
    """

    # Недопустимый email (без локальной части)
    invalid_email = "sidor..sidorov345@bk.ru"
