...
@allure.title("Регистрация с email без локальной части")
@allure.description("""
Тест проверяет реакцию системы на попытку регистрации с email без локальной части.
...
def test_invalid_local_email():
    """
    Негативный тест регистрации с недопустимым email (без локальной части).
