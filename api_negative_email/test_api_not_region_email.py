...
@allure.title("Регистрация с email без региона")
@allure.description("""
Тест проверяет реакцию системы на попытку регистрации с email без региона.
...
def test_invalid_local_email():
    """
    Негативный тест регистрации с недопустимым email (без региона).
    Ожидается отказ регистрации с сообщением об ошибке.
    """
    
    # Недопустимый email (без локальной части)
    invalid_email = "podkovirova2025@mail"
