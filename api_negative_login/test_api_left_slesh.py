...
@allure.title("Регистрация с логином, содержащим символ \\")
@allure.description(
    "Тест проверяет реакцию системы на попытку регистрации с логином, "
    "содержащим символ обратного слэша."
)
def test_invalid_login_with_backslash():
    """
    Тест регистрирует нового пользователя с логином, содержащим символ \\.
    Ожидается отказ регистрации.
    """

    # Логин с недопустимым символом
    invalid_username = "\\"
