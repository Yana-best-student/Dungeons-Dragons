...
@allure.title("Регистрация с логином, содержащим иероглифы (15 символов)")
@allure.description(
    "Тест проверяет реакцию системы на попытку регистрации с логином длиной 15 символов, "
    "содержащим китайские иероглифы. Ожидается отказ регистрации."
)
def test_invalid_login_chinese_characters():
    """
    Тест регистрирует нового пользователя с логином длиной 15 символов, содержащим иероглифы.
    Ожидается отказ регистрации.
    """

    # Логин длиной ровно 15 символов, содержащий китайские иероглифы
    invalid_username = "你好世界测试用户名"
