...
@allure.title("Регистрация с логином, начинающимся с запрещённых спецсимволов")
@allure.description(
    "Тест проверяет реакцию системы на попытку регистрации с логином длиной 10 символов, "
    "начинающимся с запрещённых спецсимволов. Ожидается отказ регистрации."
)
def test_invalid_login_starts_with_special_chars():
    """
    Тест регистрирует нового пользователя с логином длиной 10 символов, начинающимся с запрещённых спецсимволов.
    Ожидается отказ регистрации.
    """

    # Логин длиной ровно 10 символов, начинающийся с запрещённых спецсимволов
