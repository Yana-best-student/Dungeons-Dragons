...
@allure.title("Регистрация с логином, состоящим только из трёх точек")
@allure.description(
    "Тест проверяет реакцию системы на попытку регистрации с логином, "
    "содержащим только символы '...'. Ожидается отказ регистрации."
)
def test_invalid_login_only_three_dots():
    """
    Тест регистрирует нового пользователя с логином, состоящим только из трёх точек.
    Ожидается отказ регистрации.
    """

    # Логин, состоящий только из трёх точек
    invalid_username = "..."
