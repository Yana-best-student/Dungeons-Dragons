...
@allure.title("Регистрация с логином, содержащим запрещённые спецсимволы")
@allure.description(
    "Тест проверяет реакцию системы на попытку регистрации с логином, "
    "содержащим запрещённые спецсимволы."
)
def test_invalid_login_with_special_chars():
    """
    Тест регистрирует нового пользователя с логином, содержащим запрещённые спецсимволы.
    Ожидается отказ регистрации.
    """

    # Логин длиной 20 символов с запрещёнными спецсимволами
    invalid_username = "$%&*#@!^()-_+={}|~<>?"
