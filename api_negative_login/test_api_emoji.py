...
@allure.title("Регистрация с логином, содержащим эмодзи (15 символов)")
@allure.description(
    "Тест проверяет реакцию системы на попытку регистрации с логином длиной 15 символов, "
    "содержащим эмодзи. Ожидается отказ регистрации."
)
def test_invalid_login_emojis():
    """
    Тест регистрирует нового пользователя с логином длиной 15 символов, содержащим эмодзи.
    Ожидается отказ регистрации.
    """

    # Логин длиной ровно 15 символов, содержащий эмодзи
    invalid_username = "😄😂👍😊😁😃😆😉😋😎😏"
